...
//!
//! This is a direct port of the [`crate::ndb::header::NdbCryptMethod::Permute`] code from the PST specification.

use super::*;

/// Encode Unicode PST data-block bytes.
pub fn encode_block(data: &mut [u8]) {
    permute(data, key_data_r());
}

/// Decode Unicode PST data-block bytes.
