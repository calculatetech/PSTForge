...
impl HeapFillLevel {
    fn unpack_fill_levels(value: u32) -> [HeapFillLevel; 8] {
        const LEVELS: [HeapFillLevel; 16] = [
            HeapFillLevel::Empty,
            HeapFillLevel::Level1,
            HeapFillLevel::Level2,
            HeapFillLevel::Level3,
            HeapFillLevel::Level4,
            HeapFillLevel::Level5,
            HeapFillLevel::Level6,
            HeapFillLevel::Level7,
            HeapFillLevel::Level8,
            HeapFillLevel::Level9,
            HeapFillLevel::Level10,
            HeapFillLevel::Level11,
            HeapFillLevel::Level12,
            HeapFillLevel::Level13,
            HeapFillLevel::Level14,
            HeapFillLevel::Level15,
        ];
        std::array::from_fn(|index| LEVELS[((value >> (index * 4)) & 0x0F) as usize])
    }
